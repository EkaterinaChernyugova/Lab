...
// тест для проверки перегрузки оператора присваивания
...
// тест для проверки перегрузки дружественного оператора сложения
...
// тест для проверки перегрузки оператора вычитания
...
// тест для проверки перегрузки префиксного оператора инкремента
bool Test8(Goods x)
{
...
// тест для проверки перегрузки префиксного оператора декремента
bool Test9(Goods x)
{
...
// тест для проверки перегрузки постфиксного оператора инкремента
bool Test10(Goods x)
{
...
// тест для проверки перегрузки постфиксного оператора декремента
bool Test11(Goods x)
{
